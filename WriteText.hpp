...
public:
	...
	static HRESULT create_format(wil::com_ptr_t<IDWriteTextFormat>& text_format, wil::zwstring_view name = factory::DefaultFont, float size = 16.f, uint32_t weight = 400U, uint32_t style = 0U, uint32_t stretch = 5U);
